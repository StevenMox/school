        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtPhone" Display="Dynamic" ErrorMessage="US Phone Number Only" ForeColor="Red" ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}"></asp:RegularExpressionValidator>
                </td>
            </tr>
        </table>
        <p>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtHourlyRate" Display="Dynamic" ErrorMessage="RangeValidator" ForeColor="Red" MaximumValue="140.00" MinimumValue="11.25" Type="Double"></asp:RangeValidator>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <asp:RangeValidator ID="RangeValidator2" runat="server" ControlToValidate="txtOvertimeRate" Display="Dynamic" ErrorMessage="RangeValidator" ForeColor="Red" MaximumValue="140.00" MinimumValue="11.25" Type="Double"></asp:RangeValidator>
                </td>
            </tr>
        </table>
        <p>
        ...
        <table class="auto-style1">
            <tr>
                ...
                <td class="auto-style8">
                    <asp:RangeValidator ID="RangeValidator3" runat="server" ControlToValidate="txtHoursWorked" Display="Dynamic" ErrorMessage="RangeValidator" ForeColor="Red" MaximumValue="39" MinimumValue="1" Type="Integer"></asp:RangeValidator>
                ...
                <td>
                    ...
                    <asp:RangeValidator ID="RangeValidator4" runat="server" ControlToValidate="txtOvertimeWorked" Display="Dynamic" ErrorMessage="RangeValidator" ForeColor="Red" MaximumValue="39" MinimumValue="1" Type="Integer"></asp:RangeValidator>
                </td>
            </tr>
            <tr>
